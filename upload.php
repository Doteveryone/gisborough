...
<div class='image-block'>
  ...
  <div class='inner'>
    <img src='/images/upload/url-explained.png' />
  </div>
</div>
...
<p>Your device needs to turn the domain into an IP address (internet protocol). This is a unique string of numbers, and every device on the internet has one — including <a href="https://www.google.co.uk/search?hl=&site=&q=what%27s+my+ip+address">yours</a>.</p>
